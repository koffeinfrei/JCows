 ...
 */
public class VCfloat extends VC {
  
  private static final Logger LOGGER = Logger.getLogger(VCfloat.class);
   ...
   */
  public VCfloat(ParamListItem paramListItem,Composite parent) throws JCowsException {
   ...
   */
  public VCfloat(ParamListItem paramListItem,Composite parent,int arrayIndex) throws JCowsException {
