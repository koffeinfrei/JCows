 ...
 */
public class VCbyte extends VC {
  
  private static final Logger LOGGER = Logger.getLogger(VCbyte.class);
   ...
   */
  public VCbyte(ParamListItem item,Composite parent) throws JCowsException {
    this(item,parent,0);
  }
   ...
   */
  public VCbyte(final ParamListItem item,Composite parent,int arrayIndex) throws JCowsException {
    super(item,parent,arrayIndex);
