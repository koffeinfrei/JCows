...
import org.jcows.view.vc.VCshort;
import org.junit.AfterClass;
import org.junit.Before;
import org.junit.BeforeClass;
import org.junit.Test;

public class TestVCshort {
  
  private static Shell m_shell;
  private static Display m_display;
  
  private VCshort m_vcPrimitive;
  private VCshort m_vcWrapped;
  ...
  public void setUp() throws JCowsException {
    m_paramListItemPrimitive=new ParamListItem("short",true,"short value",(short)5,false);
    m_paramListItemWrapped=new ParamListItem("short",true,"short value",new Short((short)5),false);
  }
  
  @Test
  public void testVCshortParamListItemComposite() {   
    try {
      m_vcPrimitive=new VCshort(m_paramListItemPrimitive,m_shell);
      m_vcWrapped=new VCshort(m_paramListItemWrapped,m_shell);
    }
  ...
  @Test
  public void testVCshortParamListItemCompositeInt() {   
    try {
      m_vcPrimitive=new VCshort(m_paramListItemPrimitive,m_shell,0);
      m_vcWrapped=new VCshort(m_paramListItemWrapped,m_shell,0);
    }
    catch(JCowsException e) {
      fail(e.toString());
    }
    ...
    try {
      m_vcPrimitive=new VCshort(m_paramListItemPrimitive,m_shell,5);
    ...
    try {
      m_vcWrapped=new VCshort(m_paramListItemWrapped,m_shell,5);
      fail("Should have raised an ArrayIndexOutOfBoundsException.");
    }
    catch(JCowsException e) {
  ...
  public void testValidate() {
    IValidator validator1=new ShortValidator();
